...
app.put("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsWorker, inError_8, contact, inError_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, contactsWorker.deleteContact(inRequest.body._id)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
                ...
                inResponse.send("error");
                return [3 /*break*/, 5];
            case 5: return [4 /*yield*/, contactsWorker.addContact(inRequest.body)];
            case 6:
                contact = _a.sent();
            ...
            case 7:
                inError_9 = _a.sent();
                console.log("PUT /contacts: Error", inError_9);
                inResponse.send("error");
                return [3 /*break*/, 8];
